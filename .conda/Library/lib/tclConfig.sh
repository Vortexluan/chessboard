...
# installed.
TCL_PREFIX='e:/useful/vscode_projects/chessboard/.conda\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='e:/useful/vscode_projects/chessboard/.conda\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='e:/useful/vscode_projects/chessboard/.conda\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-Ie:/useful/vscode_projects/chessboard/.conda\Library\include'
...
TCL_PACKAGE_PATH='e:/useful/vscode_projects/chessboard/.conda\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-Le:/useful/vscode_projects/chessboard/.conda\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='e:/useful/vscode_projects/chessboard/.conda\Library\lib\tclstub86.lib'
